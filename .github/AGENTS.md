...
A pre-push guard confirms the tag does not already exist as a multi-platform manifest;
if it does, the rehearsal fails rather than silently degrading the manifest.
